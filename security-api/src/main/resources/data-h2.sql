...
INSERT INTO module (name, base_path) VALUES ('ORDER', '/categories');
INSERT INTO module (name, base_path) VALUES ('OWNER', '/customers');
...
INSERT INTO operation (name, path, http_method, permit_all, module_id) VALUES ('READ_ALL_OWNERS','', 'GET', false, 3);
INSERT INTO operation (name, path, http_method, permit_all, module_id) VALUES ('REGISTER_ONE_OWNER','', 'POST', true, 3);
...
INSERT INTO "user" (username, name, password, role_id) VALUES ('mhernandez', 'mengano hernández', '$2a$10$gFmb8O3D8w3YDGKhxKCGvef.V.I8yzpIeUrBZlsuS7yvAdCWtJuaG', 3);
