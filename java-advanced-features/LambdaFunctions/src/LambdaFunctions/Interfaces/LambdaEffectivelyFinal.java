...
public class LambdaEffectivelyFinal {
    ...
    public static void lambdaEffectivelyFinalTest(){
        ...
        /*  define una expresión lambda que toma una cadena y verifica si está vacía y si el valor de x es par */
    ...
    public static void filterData(List<String> list, Predicate<String> lambda) {
        ...
        } /* Si el resultado de aplicar el predicado al elemento es true, se elimina ese elemento de la lista*/
    }
